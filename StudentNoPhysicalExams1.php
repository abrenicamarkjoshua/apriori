...
else
{
 ...
 $queryStr = "Select s.Student_ID, s.lastName, s.MiddleName, s.FirstName,
            ...
            from Student s
            Inner Join 
                    (Select Distinct lp.UID, lp.VisualAcuityTest, lp.HeadTotoeAssessment, lp.VitalSigns, lp.FamilyMedicalRecord, lp.MedicalRecord
            from lab_procedure as lp
            where 

                 lp.HeadTotoeAssessment =0 and 
                 lp.VitalSigns=0 and 
                 lp.FamilyMedicalRecord=0 and 
                 lp.MedicalRecord=0) as lp on s.Student_ID=lp.uid";
