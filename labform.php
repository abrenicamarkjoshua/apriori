...
function showForm($formType,$idNo){
    ...
    if ($formType == 1){
        ...
        echo "
                ...
                <form method = 'POST' action = 'labForm.php'>
   ...
   include('connect.php');
	...
	if(isset($_POST['labSubmitBtn1'])) {
            ...
            if(mysql_num_rows($checkIfExist)>0){
                $queryStr = "INSERT INTO lab_procedure (uid,transDate,Fecalysis,Parasite,PusCell,RBC,FBacteria,Macrophages,FatGlobules) VALUES('$userid',now(),1,'$parRslt','$pusRslt','$RBCRslt','$BacRslt','$MacRslt','$FatRslt')";
            } else {
                $queryStr = "INSERT INTO lab_procedure (uid,transDate,Fecalysis,Parasite,PusCell,RBC,FBacteria,Macrophages,FatGlobules) VALUES('$userid',now(),1,'$parRslt','$pusRslt','$RBCRslt','$BacRslt','$MacRslt','$FatRslt')";
            }
        ...
        <table class = 'labtable'>
                        ...
                        <th >
                         ...
                         <tr>
                            <td align = center  ><a href = 'labproc.php'><input type = 'button' value = 'BACK'></a></td>
                        </tr>
        </table>";
            ...
            if(mysql_num_rows($checkIfExist)>0){
                ...
                $queryStr = "INSERT INTO lab_procedure (uid,transDate,Urinalysis,Color,Appearance,Glucose,Protein,UBacteria,Nitrite) VALUES('$userid',now(),1,'$ColorRslt','$AppearanceRslt','$GlucoseRslt','$ProteinRslt','$BacteriaRslt','$NitriteRslt')";
            } else {
        ...
        <table class = 'labtable'>
            ...
            if(mysql_num_rows($checkIfExist)>0){
                ...
                $queryStr ="INSERT INTO lab_procedure (uid,transDate,CBC,RedBloodCell,WhiteBloodCell,Hemoglobin,Hematocrit,Platelets) VALUES('$userid',now(),1,'$RedBloodCellRslt','$WhiteBloodCellRslt','$HemoglobinRslt','$HematocritRslt','$PlateletsRslt')";
            } else {
