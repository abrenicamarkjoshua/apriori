...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 12, 2015 at 03:38 AM
...
(7, 'Fecal_Abnormal_Parasite', 'Fecalysis Parasite', 'Change me Parasite'),
(8, 'Fecal_Abnormal_Bacteria', 'Fecalysis Bacteria', 'Suggestion Bacteria'),
(9, 'Fecal_Abnormal_Macrophages', 'Fecalysis Macrophages', 'Suggestion Macrophages'),
(10, 'Fecal_Abnormal_FatGlobules', 'Fecalysis Fat Globules', 'Suggestion Fat Globules'),
(11, 'Fecal_Abnormal_PusCell', 'Fecalysis Pus Cell', 'Suggestion Puscell'),
(12, 'CBC_Abnormal_RBC', 'CBC Red blood cell', 'We may suggest that the clinic must require students to have a regular check -up in blood to monitor each students abnormal blood count that may cause serious deceases.'),
(13, 'CBC_Abnormal_WBC', 'CBC White blood cell', 'We may suggest that the clinic must require students to have a regular check -up in blood to monitor each students abnormal blood count that may cause serious deceases.'),
(14, 'CBC_Abnormal_HEMO', 'CBC Hemoglobin', 'We may suggest that the clinic must require students to have a regular check -up in blood to monitor each students abnormal blood count that may cause serious deceases.'),
(15, 'CBC_Abnormal_HEMA', 'CBC Hematocrit', 'We may suggest that the clinic must require students to have a regular check -up in blood to monitor each students abnormal blood count that may cause serious deceases.'),
(16, 'CBC_Abnormal_Platelets', 'CBC Platelets', 'We may suggest that the clinic must require students to have a regular check -up in blood to monitor each students abnormal blood count that may cause serious deceases.');
