...
<div id="loob">
	...
	<form method = "post" action="insertad.php">
		
	&nbsp;&nbsp;Admin ID: <input type="text" id="box" name="admin_id"><br><br>
	&nbsp;&nbsp;Email: <input type="text" id="box" name="email"><br><br>
	&nbsp;&nbsp;Password: <input type="password" id="box" name="password"><br><br>
